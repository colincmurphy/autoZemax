...
if __name__ == '__main__':
    ...
    for j in range(len(fieldX)):
        averages.append(polarizationRotation.getAverageOfPupilMap(10, 1, (j + 1), 12, 10))     
    ...
    #Code V data
    code_v_averages = [-0.8904363564, -0.621753973, -0.891779109, -1.15162092, 
                       -0.8786324305, -0.3648190227, -0.4851407493, -0.8803130792, 
                       -1.26628921, -1.490164181, -1.33760935, -1.028343352, 
                       -0.5804272792, -0.04800698161, -0.1004709843, -0.4111519667, 
                       -0.8817761025, -1.342921211, -1.687557424, -1.858882103, 
                       -1.782394707, -1.505799217, -1.068229327, -0.5917985416, 
                       -0.2194042687]
    
    #calculate difference between OS and Code V
    
    for i in range(len(code_v_averages)):
        averages[i] = (averages[i]-code_v_averages[i])
    plt.scatter(fieldX, fieldY, c = averages)
    plt.colorbar()
    plt.title("Difference between OpticStudio and Code V FOV Map PA2")
