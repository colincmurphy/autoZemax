# -*- coding: utf-8 -*-
"""
Created on Tue Jun 28 10:53:00 2022
...
if __name__ == '__main__':
    ...
    path = os.path.join(os.sep, sampleDir,  r'ACTpol_v28_150GHz.ZMX')
    setup(path)
    ...
    for j in range(len(fieldX)):
        averages.append(polarizationRotation.getAverageOfPupilMap(59, 1, (j + 1), 12, 10))     
    ...
    plt.colorbar()
    plt.title("All Optics Rotation on Sky OpticStudio - PA2")
